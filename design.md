...
| H2 | Título de cada sección (Sobre mí, ABCIS, Servicios, ¿Cuál es tu situación?, No vendo paquetes, Proceso, Resultados, Testimonios, FAQ, Contacto, Blog) | Bricolage Grotesque | 800 | 64px | 28px | `line-height: 1.05`. Mismo tamaño en TODAS las secciones — es el nivel de "título de sección", no varía por importancia percibida de cada una. Se mantiene por debajo del H1 (72px) para preservar la jerarquía del hero como punto de entrada más grande de la página. Testimonios es sección propia (su propio `<section>`), separada de "Resultados" — no anidada. |
